...
class MongoDBSessionInterface(ServerSideSessionInterface):
    ...
    ttl = ...
    def __init__(self, app: Flask, client: Optional[MongoClient] = ..., key_prefix: str = ..., use_signer: bool = ..., permanent: bool = ..., sid_length: int = ..., serialization_format: str = ..., db: str = ..., collection: str = ...) -> None:   # type: ignore
        ...
