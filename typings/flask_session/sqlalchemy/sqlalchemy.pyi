...
def create_session_model(db, table_name, schema=..., bind_key=..., sequence=...): # -> type[Session]:
...
class SqlAlchemySessionInterface(ServerSideSessionInterface):
    ...
    ttl = ...
    def __init__(self, app: Optional[Flask], client: Optional[SQLAlchemy] = ..., key_prefix: str = ..., use_signer: bool = ..., permanent: bool = ..., sid_length: int = ..., serialization_format: str = ..., table: str = ..., sequence: Optional[str] = ..., schema: Optional[str] = ..., bind_key: Optional[str] = ..., cleanup_n_requests: Optional[int] = ...) -> None:
        ...
