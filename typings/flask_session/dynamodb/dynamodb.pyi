...
from mypy_boto3_dynamodb.service_resource import DynamoDBServiceResource    # type: ignore
...
class DynamoDBSessionInterface(ServerSideSessionInterface):
    ...
    def __init__(self, app: Flask, client: Optional[DynamoDBServiceResource] = ..., key_prefix: str = ..., use_signer: bool = ..., permanent: bool = ..., sid_length: int = ..., serialization_format: str = ..., table_name: str = ...) -> None:   # type: ignore
        ...
